...
echo '<div class="rrze-calendar individual-event">';
                    ...
                    foreach ((array)$dayEvents as $time => $events) {
                        foreach ((array)$events as $event) {
                            ...
                            if ($time == 'all-day') {
                                ...
                                if (!empty($calendarUrl)) {
                                    printf('<div class="calendar-url wp-element-button"><button href="%1$s" target="_blank">%2$s <span class="dashicons dashicons-external"></span></button></div>', $calendarUrl, __('View the calendar', 'rrze-calendar'));
                                }
                                if (!empty($feedUrl)) {
                                    printf('<div class="feed-url wp-element-button"><button href="%1$s">%2$s</button></div>', $feedUrl, __('Subscribe to calendar', 'rrze-calendar'));
                                }
                                echo '</div>';
                            }
                        }

                ...
                ?>
                    <div class="event-item" itemscope itemtype="http://schema.org/Event">
                        ...
                        <h2 class="event-title" itemprop="name">
                            <a itemprop="url" href="<?php echo esc_attr(RRZE_Calendar::endpoint_url($event->slug)); ?>" title="<?php echo esc_attr($event->label . ', ' . $event->long_start_date); ?>"><?php echo preg_replace('/[^[:alpha:]\s]/', '', $event->label); ?></a>
                        </h2>
                        <div class="event-info">
                            ...
                            <p class="event-location" itemprop="location">
                                <?php if ($location && $event->location) : ?>
                                    <?php printf('<strong>%1$s: </strong>%2$s', __('Location', 'rrze-calendar'), $event->location); ?>
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>

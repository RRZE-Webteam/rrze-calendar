...
class RSet implements RRuleInterface
{
	...
	/**
	 * Add a RRZE\Calendar\Vendor\Dependencies\RRule (or another RSet)
	 *
	 * @param mixed $rrule an instance of RRuleInterface or something that can be transformed into a RRZE\Calendar\Vendor\Dependencies\RRule (string or array)
	 * @return $this
	 */
	 ...
	 *
	 * @return array Array of RRZE\Calendar\Vendor\Dependencies\RRule
	 */
	...
	/**
	 * Add a RRZE\Calendar\Vendor\Dependencies\RRule with exclusion rules.
...
// Private methods
	 ...
	 * Each heap contains multiple iterators (either RRZE\Calendar\Vendor\Dependencies\RRule or ArrayIterator)

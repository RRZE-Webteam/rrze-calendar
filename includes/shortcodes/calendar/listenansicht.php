                    ...
                    <ul>
                        <?php foreach ($daten['termine'] as $termin): ?>
                            <li class="<?php if (!empty($termin['heute'])) echo 'event-today'; ?>">
                                <?php // echo date('d',$termin['start_timestamp']);die; ?>
                                ...
                                <div class="event-info event-id-<?php echo $termin['id']; ?><?php
                                if (($termin['ganztagig'])) : echo 'event-allday';
                                endif;
                                ?>"><?php if (!empty($termin['nicht_ganztagig'])): ?>
                                        <div class="event-time">
                                            
                                   <?php echo date_i18n('d-m-Y', $termin['start_timestamp']).'  '; ?>
                                        <?php printf(__(" %s Uhr", 'rrze-calendar'), $termin['time']); ?>
                                        </div>
                                        <?php else : ?>
                                        <div class="event-time">
                                        <?php printf(__("All Day event", 'rrze-calendar'), $termin['time']); ?>
                                        </div>
        <?php endif; ?>

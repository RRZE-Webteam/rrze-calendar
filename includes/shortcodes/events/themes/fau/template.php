                ...
                <?php foreach ($event_date as $event) :
                    ...
                    <li>
                        <div class="event-item" itemscope itemtype="http://schema.org/Event">
                            <meta itemprop="startDate" content="<?php echo date_i18n('c', strtotime($event->start)); ?>"><meta itemprop="endDate" content="<?php echo date_i18n('c', strtotime($event->end)); ?>">
                            ...
                            <div class="event-info">
                                ...
                                <div class="event-location" itemprop="location">
                                    <?php echo ($location && !empty($event->location)) ? nl2br($event->location) : '&nbsp;'; ?>
                                </div>
                            </div>
                        </div>
                    </li>

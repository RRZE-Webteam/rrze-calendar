...
class Events
{
    ...
    {
        add_submenu_page(
            'edit.php?post_type=' . CalendarFeed::POST_TYPE, // parent slug
            __('All Events', 'rrze-calendar'), // page title
            __('All Events', 'rrze-calendar'), // menu title
            'manage_options', // capability
            'all_events', // menu slug
            [__CLASS__, 'loadEventsPage'], // callable function
            2 // position

        );
    }

    public static function loadEventsPage()
    {
        ...
        '<input type="hidden" name="post_type" value="' . CalendarFeed::POST_TYPE . '">',
        '<input type="hidden" name="page" value="all_events">',
        $events->search_box(__('Search Events', 'rrze-calendar'), 'title'),
        '</form>';
    ...
    public static function getFeeds(array $postIn = [])
    {
        $args = [
            'numberposts' => -1,
